...
if __name__ == '__main__':
    ...
    word2vecExtModel = \
        word2vecext.Word2VecExt.load_or_fit_words_and_save(train_words,
                                                           train_ready.dataframe["start_indices"].tolist(),
                                                           rsc_dir + "/word2vec",
                                                           vector_size=num_features,
                                                           reset=False)
    train_data = word2vecExtModel.vectorize_valid(train_words)
    validation_data = word2vecExtModel.vectorize_valid(validation_words)
    ...
    f.write("Actual validation size: " + str(len(validation_x)) + "\n")
    f.write("use_word2vec: " + str(use_word2vec) + "\n")
